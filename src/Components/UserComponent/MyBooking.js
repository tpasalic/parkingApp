              ...
              <MuiThemeProvider>
                  <div>
                    ...
                    <Paper style={style} zDepth={4} rounded={false} id="abc" >
                     ...
                     <p> Date : {item.date}</p>
                     <p>Vrijeme početka: {item.startTime}</p>
                     <p>Vrijeme isteka: {item.endTime} </p>
                     <p>Broj mjesta. :{item.slotNumber} </p>
                     <p>Naziv Parkinga:{item.loc_name}</p>
                    
                   
                    <RaisedButton label="Otkaži rezervaciju" primary={true}  onClick={this.DeleteSlot.bind(this,index)}/>
                     <br/>
                    </Paper>
                       </div>
                     ))}
