...
Book(item){
  ...
  if (typeof this.state.startTime === 'string' || this.state.startTime instanceof String
  || typeof this.state.endTime === 'string' || this.state.endTime instanceof String){
  ...
  alert("Parking je rezervisan za vas")
}
                            ...
                            <h2> Rezerviši parking mjesto {this.state.slotNumber}</h2>
                                  <TimePicker defaultTime={this.state.startTime}
                                   ...
                                   <TimePicker 
                                        ...
                                        style={{display: 'inline-block'}} 
                                        floatingLabelText="Vrijeme isteka" 
                                        // autoOk={true}
                                        />
                                   ...
                                   <DatePicker autoOk={true} 
                                        ...
                                        style={{display: 'inline-block'}} 
                                        floatingLabelText="Izaberi datum" />
                            <Price 
                              startTime={this.state.startTime} 
                              endTime={this.state.endTime}/>                          
                           <RaisedButton label="Rezerviši kasnije" onTouchTap={this.handleReduce} />
                          <RaisedButton label="Izaberi mjesto" primary={true} 
                          onTouchTap = {() => {
                   ...
                   <Card expanded={this.state.expanded} onExpandChange={this.handleExpandChange}>
                            <CardText expandable={true}>
                                  ...
                                  { this.state.slot_array.map((item, index) => (
                                        <span>
                                            <RaisedButton label=  {"Pozicija "+item} primary={true} onTouchTap = {() => {
