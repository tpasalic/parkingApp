...
render(){
  ...
  />
        ...
        <Drawer open={this.state.open}>
                ...
                <MenuItem onTouchTap={this.AddParkingLocations.bind(this)}>Dodaj Parking mjesta</MenuItem>
                <MenuItem onTouchTap={this.ParkingLocation.bind(this)}>Pogledaj Parking mjesta</MenuItem>
                <MenuItem onTouchTap={this.ViewAllUser.bind(this)}>Pogledaj Svi korisnici</MenuItem>
                <MenuItem onTouchTap={this.ViewAllBooking.bind(this)}>Pogledaj All Booking</MenuItem>
                <MenuItem onTouchTap={this.Userfeedback.bind(this)}>Utisci</MenuItem>
